                ...
                <div className="col-md-8">
                    <div className="main">
                        ...
                        <Select id="response-select" 
                            className="response-select mt-3 mb-3"
                ...
                <div className="col-md-4">
                    <div className="tools">
                        ...
                        <div className={me.state.test_success? "row alert alert-success" : "row alert alert-danger"} >
                            ...
                            {me.state.test_done &&
                                <div className="col-sm-12 mt-3">
                                    <textarea className="input-test-note"
                                        ...
                                        return(
                                            <div className="row"> 
                                                <div className="col-sm-12">
                                                    ...
                                                    <label for={'param_' + param.key}><b>{param.key}</b></label>
                                                </div>                                      
                                                <div className="col-sm-12">  
                                                    <input type="text" className="param" id={'param_' + param.key}
