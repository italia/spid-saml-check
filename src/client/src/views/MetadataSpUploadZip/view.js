                                    ...
                                    <div>
                                        ...
                                        <button type="button"
                                            ...
                                            onClick={(e)=>{me.uploadMetadataZip(me.refs.inputMetadata.files[0])}}>
                                                <span className="fa fa-upload"></span> Upload ZIP</button>
                                    </div>
                                }
                                {me.state.loading &&
                                    <div>
                    ...
                    <div className="col-md-8">
                        ...
                        {me.state.report!=null && 
                            <div className="row testset"> 
                                <div className="col-sm-12">
                                    <p>File: <b><span className="first-upper">{me.state.fileName}</span></b></p>
                                    <p>Num. Metadata: <b><span className="first-upper">{me.state.report.metadata.length}</span></b></p>
